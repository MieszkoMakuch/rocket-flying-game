...
/* package RocketFlyingGame-1.0 */
#define VERSION_RocketFlyingGame "1.0"
#define MIN_VERSION_RocketFlyingGame(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "RocketFlyingGame-1.0"

#define CURRENT_PACKAGE_KEY "RocketFlyingGame-1.0"
